...
class CustomImageDataset(Dataset):
    def __init__(self, data_dir, mode="train"):
        ...
        if mode == "train":
            ...
            annotation_file = os.path.join(data_dir, "annotations", "person_keypoints_train2017.json")
        elif mode == "test":
...
if __name__ == "__main__":
    dataset = CustomImageDataset(data_dir="C:/Users/22969/OneDrive/文档/application/大语言模型科研/data", mode="test")
